		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portal Facturacion",
									"targetURL": "#monitorpedidos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"monitorpedidos-display": {
								"semanticObject": "monitorpedidos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=monitorpedidos",
									"url": sap.ui.require.toUrl("monitorpedidos")
								}
							}
						}
					}
